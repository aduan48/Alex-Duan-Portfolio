...
function Contact() {
  ...
  return (
    <div>
        ...
        <h2 className = 'contact-header'>Ready To Level Up Your Branding & Website?</h2>
        <p className='contact-us-description'>Fill out this form to inquire more about my services!</p>
        <form method='POST' name = 'contact' data-netlify="true" onSubmit = {handleSubmit}>
          <input type = "hidden" name = "form-name" value = "contact" />
          <label htmlFor='name'>Name:</label>
          <input type= 'text' id = 'name' name = "name" placeholder = "Chad Doe" value ={name} onChange={handleName} required/>
